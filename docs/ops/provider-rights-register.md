...
| `openai_responses_web_search_auto` | Official API experiment with web-search tool | `disabled` | Natural web-search choice experiment in the OpenAI Responses API. This is an API experiment rather than ChatGPT. | Before activation, review model/configuration, cost, data-handling, and labels. |
| `openai_responses_web_search_required` | Official API experiment with web-search tool | `disabled` | Required-retrieval experiment in the OpenAI Responses API. This is an API experiment rather than ChatGPT. | Before activation, review model/configuration, cost, data-handling, and labels. |

...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .layout > *,.stack > *,.metric-grid > *,.evidence-top > *,.meta > * { min-width:0; }
...
<body>
  ...
  <main>
    <header>
      ...
      <p class="status" id="status" role="status" aria-live="polite">Loading evidence…</p>
    </header>
    <div class="layout">
      <div class="stack">
  ...
  <script>
    ...
    const evidenceStateLabel = (() => {
      ...
      return (state) => Object.hasOwn(labels, state) ? labels[state] : 'Unresolved is a valid result.';
    })();
